                ...
                @foreach ($products as $product)
                    <div style="width: 320px; height: 480px;" class="bg-white overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
                        <div style="width: 320px; height: 220px; overflow: hidden;">
                            @if($product->image_path)
                                <img src="/storage/{{ $product->image_path }}" 
                                     alt="{{ $product->name }}" 
                                     style="width: 320px; height: 220px; object-fit: cover; object-position: center;"
                                     class="bg-gray-100">
                            @else
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            <div class="flex-1">
                                <h3 class="text-xl font-bold mb-2 text-gray-800 truncate">{{ $product->name }}</h3>
                                <div class="space-y-2">
                                    ...
                                    <p class="flex items-center text-gray-600">
                                        ...
                                        <span class="font-medium">Especialidad:</span> {{ $product->medicalSpecialty ? $product->medicalSpecialty->name : 'Sin especialidad' }}
                                    </p>
                                    <p class="flex items-center text-gray-600">
                                        <svg class="w-5 h-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                        </svg>
                                        <span class="font-medium">Categoría:</span> {{ $product->category }}
                                    </p>
                                </div>
                            </div>
