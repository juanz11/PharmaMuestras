    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('representatives.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="zone" name="zone" type="text" class="mt-1 block w-full" required />
                        ...
                        <div class="mt-6">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Ingrese la cantidad de médicos para cada especialidad (0 si no hay médicos)</p>
                                ...
                                @foreach($specialties as $specialty)
                                    <div class="p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <input type="number" 
                                               ...
                                               min="0"
                                               value="{{ old('doctors.' . $specialty->id, 0) }}"
                                               required>
