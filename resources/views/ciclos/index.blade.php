                            ...
                            @foreach ($ciclos as $ciclo)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            $numero = preg_match('/Ciclo (\d+)/', $ciclo->nombre ?: 'Ciclo ' . $ciclo->id, $matches) ? $matches[1] : null;
                                            $numeroRomano = $numero ? NumberToRoman::convert($numero) : $numero;
                                        @endphp
                                        Ciclo {{ $numeroRomano }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            @if($ciclo->status === 'pendiente')
                                                ...
                                                <form action="{{ route('ciclos.destroy', $ciclo) }}" method="POST" class="inline" onsubmit="return confirm('¿Está seguro de que desea eliminar este ciclo?');">
                                                    @csrf
                                                    @method('DELETE')
